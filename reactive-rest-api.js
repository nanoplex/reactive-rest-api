...
(function (RestApi) {
    ...
    var Server = (function () {
            ...
            return new Promise(function (resolve, reject) {
                ...
                function routeFilter() {
                    ...
                    routes.filter(function (route) { return ("/" + route.name === url.path); })
                        .map(function (route) { return _this.execute_method(route[method], route.object_defenition, url.parameters).then(resolve).catch(reject); });
                }
        ...
        Server.prototype.execute_method = function (method, object_defenifion, paramerters) {
            var values = paramerters.map(function (parameter) {
            ...
            console.log(values);
            return method.apply(null, values);
        };
        return Server;
    })();
